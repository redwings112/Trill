...
import { getAuth, onAuthStateChanged as onAuthStateChangedFirebase   } from "firebase/auth";
...
// Export instances
export { app, auth, db, storage, onAuthStateChangedFirebase as onAuthStateChanged };
